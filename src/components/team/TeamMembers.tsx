            ...
            return (
              ...
              >
                <span
                  className={
                    m.featured
                      ? "inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[image:var(--gradient-brand)] text-white"
                      : "inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--brand-tint)] text-[var(--brand)]"
                  }
                >
